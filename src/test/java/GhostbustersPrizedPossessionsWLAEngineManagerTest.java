...
public class GhostbustersPrizedPossessionsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GhostbustersPrizedPossessionsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/GhostbustersPrizedPossessionsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GhostbustersPrizedPossessionsWLAIW/InitOutcome.xml").getDocumentElement();
